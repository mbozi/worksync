...
Public Class DatabaseController
    ...
    'Public Function OpinionPolls() As PartialViewResult
    '    Dim model As New PollingParms With {
    '            .PollData = DLayer.GetPollModel(),
    '            .PollComps = New SelectList(DLayer.GetPollingCompaniesModel.OrderBy(Function(x) x.ID <> 0).ThenBy(Function(x) x.PollerName), "ID", "PollerName")
    '            }
    '    Return PartialView(PARTIAL_VIEW_FOLDER & "_PollPage.cshtml", model)
    'End Function
